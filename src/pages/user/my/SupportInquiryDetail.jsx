...
export default function SupportInquiryDetail() {
  ...
  return (
    <div className="flex h-full flex-col bg-white">
      ...
      {inquiry.answerDate && (
        <div className="h-[12px]  bg-[#EEEEEE] my-3" />
      ...
      <div className="flex-1 space-y-6 px-4 py-5">
        ...
        {inquiry.answer && (
          <section className="space-y-2">
            ...
            <div className="rounded-lg text-[14px] text-[#1e1e1e] whitespace-pre-line">
              {inquiry.answer}
            </div>
          </section>
        )}
      ...
      <footer className="flex gap-3  px-4 py-[32px]">
        ...
        <button
          ...
          className="
            flex-1 rounded-lg border border-[#27BE69]
            py-3 text-[15px] font-medium text-[#27BE69]
          "
        >
          삭제
        </button>
