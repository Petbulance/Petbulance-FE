...
export default function SettingsView() {
  ...
  return (
    <div className="animate-in fade-in space-y-6 duration-500">
      ...
      <div className="bg-blue-50 p-4 rounded text-sm text-blue-800 mb-4 flex items-start gap-2">
        <Shield size={16} className="mt-0.5 shrink-0"/>
        <p>모든 관리자 계정은 서비스 내 데이터 편집 및 최종 승인에 대해 Edit 권한을 가지며, 보안을 위해 모든 행동은 로그에 기록됩니다.</p>
      </div>
            ...
            <tr key={adm.id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 text-center">
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md bg-red-50 px-3 py-1 text-xs font-medium text-red-600 hover:bg-red-100 transition"
                >
