  ...
  return (
    ...
    <div className="animate-in fade-in space-y-6 duration-500">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        {[{ label: '서비스 가입자', value: '1,240', change: '▲ 12.5%', color: 'red' }, {
          label: '병원검색 횟수',
          value: '3,500',
          change: '▲ 5.2%',
          color: 'red',
        }, {
          label: '후기 작성 수', value: '45', change: '▼ 2.1%', color: 'blue',
        }, {
          label: '게시글 작성 수', value: '120', change: '▲ 8.4%', color: 'red',
        }].map((kpi, i) => (<div
            key={i}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm ">
          ...
          <div className="divide-y divide-gray-100">
            {[{
              name: '부적절한 게시글 신고', time: '2분 전', priority: 'high', value: '5,200',
            }, {
              name: '로그인 오류 발생', time: '5분 전', priority: 'high', value: '890',
            }, {
              name: '아크리스 동물병원', time: '45분 전', priority: 'medium', value: '3,100',
            }].map((item, i) => (<div
              key={i}
