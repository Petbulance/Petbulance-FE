          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2">
                  <input
                    className="mt-2 w-1/2 rounded border border-gray-200 p-2 text-sm text-gray-400"
                    value="37.12345"
                    readOnly
                  />
                  <input
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                  {[
                    ...
                    <div key={day} className="flex items-center gap-2 text-sm">
                      ...
                      <input
                        className="mt-2 flex-1 rounded border border-gray-200 px-2 py-1 text-xs text-gray-700"
                        value={value}
                        readOnly
                      />
                    </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  className="mt-2 h-32 w-full rounded border border-gray-200 p-3 text-sm"
