    ...
    <div className="animate-in fade-in space-y-6 duration-500">
      ...
      <div className="flex items-end gap-4 rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
        <div className="w-[40%] space-y-1">
          <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 transition focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-200">
        ...
        <select className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 text-sm transition focus:border-green-500 focus:ring-2 focus:ring-green-200 focus:outline-none">
        ...
        <button className="rounded-lg bg-blue-600 px-6 py-2 text-sm font-bold text-white transition hover:bg-blue-700">
          검색
        </button>
      </div>
                    ...
                    <div className="inline-flex flex-col gap-1">
                      ...
                      {(u.type === 'comunity' || u.type === 'all') && (
                        <button
                          ...
                          className="rounded-md bg-blue-50 px-3 py-1 text-xs font-medium text-blue-600 transition hover:bg-blue-100"
                        >
                          커뮤 정지 해제
                        </button>
                      )}
      ...
      <ConfirmModal
        open={confirm.open}
        title={confirm.action === 'DELETE' ? '탈퇴 처리' : '정지 해제'}
        message={
